...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("F:\\Code\\Workspace_JavaEE\\Projects\\guli-parent\\service\\service-order" + "/src/main/java");
        gc.setAuthor("lxy");
        ...
        strategy.setInclude("t_order","t_pay_log");//根据数据库中表的结构逆向生成代码
        strategy.setNaming(NamingStrategy.underline_to_camel);//数据库表映射到实体的命名策略
        strategy.setTablePrefix("t" + "_"); //生成实体时去掉表前缀t_
